          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <a href={`tel:${PHONE}`} className="flex items-center gap-3 border-2 border-sky-500/30 text-sky-300 hover:bg-sky-500/10 px-6 py-3 rounded font-bold transition-all">
                  📞 {PHONE}
                </a>
              </div>
            </div>
